...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # For public API endpoints
    ],
...
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@eatfast.cm')
SUPPORT_EMAIL = config('SUPPORT_EMAIL', default='support@eatfast.cm')
